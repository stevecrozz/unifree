...
pub fn iana_to_posix_tz(iana: &str) -> Option<&'static str> {
    match iana {
        // Europe
        "Europe/Berlin" | "Europe/Amsterdam" | "Europe/Stockholm" | "Europe/Vienna" | "Europe/Zurich" | "Europe/Copenhagen" | "Europe/Oslo" | "Europe/Paris" | "Europe/Rome" | "Europe/Warsaw" | "Europe/Madrid" | "Europe/Brussels" | "Europe/Budapest" | "Europe/Prague" | "Europe/Belgrade" => Some("CET-1CEST,M3.5.0,M10.5.0/3"),
        "Europe/London" | "Europe/Dublin" | "Europe/Lisbon" => Some("GMT0BST,M3.5.0/1,M10.5.0"),
        "Europe/Helsinki" | "Europe/Athens" | "Europe/Bucharest" | "Europe/Istanbul" | "Europe/Kiev" | "Europe/Riga" | "Europe/Sofia" | "Europe/Tallinn" | "Europe/Vilnius" => Some("EET-2EEST,M3.5.0/3,M10.5.0/4"),
        "Europe/Moscow" => Some("MSK-3"),
        
        // North America
        "America/New_York" | "America/Detroit" | "America/Toronto" | "America/Montreal" => Some("EST5EDT,M3.2.0,M11.1.0"),
        "America/Chicago" | "America/Winnipeg" | "America/Mexico_City" => Some("CST6CDT,M3.2.0,M11.1.0"),
        "America/Denver" | "America/Edmonton" => Some("MST7MDT,M3.2.0,M11.1.0"),
        "America/Los_Angeles" | "America/Vancouver" | "America/Tijuana" => Some("PST8PDT,M3.2.0,M11.1.0"),
...
pub fn get_default_timezone_for_country(iso: &str) -> &'static str {
    match iso.to_uppercase().as_str() {
        "DE" | "AT" | "CH" | "NL" | "BE" | "LU" | "FR" | "ES" | "IT" | "PL" | "CZ" | "DK" | "NO" | "SE" => "Europe/Berlin",
